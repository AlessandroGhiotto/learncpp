...
// This function IS MADE CONSTEXPR because it just calculates a value from its inputs and return it.
...
{
    constexpr double gravity{9.8}; // CONSTEPR because it's a compile-time constant
