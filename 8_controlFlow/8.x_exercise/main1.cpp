...
double calculateBallHeight(double towerHeight, int seconds)
{
    ...
    const double fallDistance{Const::gravity * (seconds * seconds) / 2.0};
...
int main1()
{
    ...
    // OPTION 1
    for (int t{0}; calculateAndPrintBallHeight(towerHeight, t) > 0.0; ++t)
    {
    }
    ...
    // do
    // {
    //     ballHeight = calculateBallHeight(towerHeight, t);
    //     printBallHeight(ballHeight, t);
    //     t++;
